...
class _CreateDigiLockState extends State<CreateDigiLock> {
  ...
  void initState(){
    ...
    daysController.addListener((){
      setState(() {
        displayCard = int.parse(daysController.text) >= 10 && int.parse(daysController.text) <= 365;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Number of Days", style: TextStyle(fontWeight: FontWeight.bold,fontSize: isMobile?16:19),),
        centerTitle: true,
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: Text("Step 1 of 5", style: TextStyle(fontSize: isMobile?11:13),)),
            Padding(
              padding: EdgeInsets.symmetric(vertical: spacing*5),
              child: Text("Enter the amount of days you want to lock your funds", textAlign: TextAlign.center, style: TextStyle(fontSize: isMobile?12:14),),
            ),
            Text("Number of Days", style: TextStyle(fontWeight: FontWeight.bold, fontSize: isMobile?13:15),),
            TextFormField(
              ...
              decoration: InputDecoration(
                hint: Text("Enter days(10-365)",style: TextStyle(color: Colors.grey, fontSize: isMobile?11:13),),
            ...
            SizedBox(height: 20,),
            Text("Available Rates",style: TextStyle(fontWeight: FontWeight.bold, fontSize: isMobile?11:13),),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(rate,style: TextStyle(fontWeight: FontWeight.bold,color: rateColor,fontSize: 12),)
        ],
      ),
    );
  }
