          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text("Save Smarter with", style: TextStyle(color: Colors.white, fontSize: 35.0, fontWeight: FontWeight.bold),),
                Text("Digikolo", style: TextStyle(color: const Color.fromARGB(255, 3, 30, 112), fontSize: 35.0, fontWeight: FontWeight.bold),),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("Your gigital", style: TextStyle(color: Colors.white, fontSize: 35.0, fontWeight: FontWeight.bold),),
                    SizedBox(width: 10.0,),
                    Text("savings",  style: TextStyle(color: const Color.fromARGB(255, 3, 30, 112), fontSize: 35.0, fontWeight: FontWeight.bold),),
                  ],
                ),
                Text("partner", style: TextStyle(color: const Color.fromARGB(255, 3, 30, 112), fontSize: 35.0, fontWeight: FontWeight.bold),),
